...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "MilkSwap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/jadjadam123/pancake-uikit/blob/master/src/widgets/Menu/logo.svg?raw=true", alt: "berry Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/jadjadam123/pancake-uikit/blob/master/src/widgets/Menu/berry.svg?raw=true", alt: "berry Logo", className: "desktop-icon" }))) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "MilkSwap home page" },
            React__default['default'].createElement("img", { src: "https://github.com/jadjadam123/pancake-uikit/blob/master/src/widgets/Menu/logo.svg?raw=true", alt: "berry Logo", className: "mobile-icon" }),
            React__default['default'].createElement("img", { src: "https://github.com/jadjadam123/pancake-uikit/blob/master/src/widgets/Menu/berry.svg?raw=true", alt: "berry Logo", className: "desktop-icon" })))));
};
